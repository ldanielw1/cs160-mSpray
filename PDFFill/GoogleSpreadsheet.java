...
public class GoogleSpreadsheet {
     ...
     * 
     * @param username - The username for logging in to Google Docs.
     * @param password - The password for logging in to Google Docs.
     * @param spreadsheetTitle - The title of Google Doc spreadsheet.
     * @param worksheetTitle - The title of the worksheet in the Google Doc.
     *            spreadsheet.
     * 
     * @throws IOException
    ...
    public GoogleSpreadsheet(String username, String password, String spreadsheetTitle,
        ...
        this.spreadsheet = getSpreadsheet(service, SPREADSHEET_FEED, spreadsheetTitle);
     ...
     * HashMap.
     * 
     * @param requiredMatches - the fields whose data should match uploadData's.
     * @param uploadData - the data we want to appear in the editted row.
     */
    public boolean containsRow(List<String> requiredMatches, HashMap<String, String> uploadData) {
        try {
     ...
     * @param uploadData - The data we want to appear in the editted row.
     */
    public boolean editRow(List<String> requiredMatches, HashMap<String, String> uploadData) {
        try {
            URL listFeedUrl = worksheet.getListFeedUrl();
            ListFeed listFeed = service.getFeed(listFeedUrl, ListFeed.class);
    ...
    /**
     * Returns all of the data in the spreadsheet.
     * 
     * @return A list of rows in the spreadsheet.
     */
    ...
    /**
     * Gets all of the data in one column of the spreadsheet.
     * 
     * @param The name of the column.
     * @return The list of entries in the spreadsheet.
     */
     ...
     * 
     * @param spreadsheetService - The service for manipulating a spreadsheet.
     * @param spreadsheetFeed - The permissions used on the spreadsheet.
     * @param spreadsheetTitle - The title of the spreadsheet
     * 
     ...
     * @throws ServiceException
     */
    private static SpreadsheetEntry getSpreadsheet(SpreadsheetService spreadsheetService,
            String spreadsheetFeed, String spreadsheetTitle) throws IOException, ServiceException {
        /** Make a request to the API and get all spreadsheets. */
        // Define the URL to request. This should never change.
        SpreadsheetFeed feed = spreadsheetService.getFeed(new URL(spreadsheetFeed),
        ...
        if (spreadsheets.size() == 0)
            ...
            throw new IllegalStateException("No spreadsheet for name: " + spreadsheetTitle);
     ...
     * 
     * @param spreadsheetService - The service for manipulating a spreadsheet.
     * @param spreadsheetEntry - The object representing the spreadsheet.
    ...
    private static WorksheetEntry getWorksheet(SpreadsheetService service,
            SpreadsheetEntry spreadsheetEntry, String worksheetTitle) throws IOException,
            ServiceException {
