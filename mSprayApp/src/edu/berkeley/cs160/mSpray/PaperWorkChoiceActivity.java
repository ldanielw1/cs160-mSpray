...
public class PaperWorkChoiceActivity extends BaseMainActivity {
	...
	/**
	 * Overriding the back button. I thought it was a solid decision because why would they go back after the achieved a GPS?
	 * It just makes the app more complicated if you include the ability to go back at this step. 
	 */
	@Override
